...
void MainMenuPG_Start(Page* page)
{
    ...
    UI_AddImage(page->ui, 0, 0, 1000, 550, true, "Futon_Room.png");
    UI_AddButton(page->ui, 50, 150, 200, 50, "Button test", 16, sf::Color::White, "nametag.png", MainMenuPG_OnButtonClick, page);
    UI_AddButton(page->ui, 50, 220, 200, 50, "About", 16, sf::Color::White, "nametag.png", MainMenuPG_OnButtonClick2, page);
    data->heading = UI_AddText(page->ui, 10, 10, "Abc 123", TextStyle::NORMAL, 24, sf::Color::White);
}
